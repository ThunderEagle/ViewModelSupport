...
namespace ViewModelSupportTests
{
	...
	public class ActiveViewModelTests
	{
		...
		[Test,Ignore("Not Dynamic anymore")]
		...
		{
			Assert.Throws<ArgumentException>(() => new InvalidDependencyCheckingForMethod());
		...
		{
			Assert.Throws<ArgumentException>(() => new InvalidDependencyCheckingForProperty());
		}
	}
}
